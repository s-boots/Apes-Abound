...
# Version 5.1.3 11/27/2023
#   * Added motion event handling
#   sboots804
...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        self.items = []
        self.bind("<Motion>", self._onMouseMove) # My revision...
        self.isMouseClicked = False # My revision...
        self.mouseX = -1 # My revision...
        self.mouseY = -1 # My revision...
    ...
    def move_to(self, x, y):
        ...
        if canvas and not canvas.isClosed():
            ...
            if self.anchor is not None:
                self.canvas.move(self.id, self.anchor.x - x, self.anchor.y - y)
            if canvas.autoflush:
                _root.update()
